...
def log_request_end(
    request, response, duration: float, logger: Optional[logging.Logger] = None
) -> None:
    """
...
def log_error(
    error: Exception, request=None, logger: Optional[logging.Logger] = None
) -> None:
    """
